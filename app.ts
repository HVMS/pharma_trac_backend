...
import { getAllMedicineStartsWithARouter } from "./controller/medicine/getMedicineStartsWithARouter";
...
app.use('/getMedicineStartsWithA', getAllMedicineStartsWithARouter);
